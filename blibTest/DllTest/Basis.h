...
BLIBDLL_API uint64_t GetRunTimeMs();																					//universal GetTickCount function (windows, unix, etc)
BLIBDLL_API void SleepMs(uint64_t ms);																				//universal Sleep function

BLIBDLL_API size_t GetHashCode(const std::type_info* classType);							//get a hash of a class type
BLIBDLL_API size_t GetHashSize();																							//get size of hash, sizeof(size_t)
